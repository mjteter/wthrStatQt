...
def psych(output_str, input_str_1, input_1, input_str_2, input_2, pressure=14.696):
    ...
    input_2: input
    pressure (default=14.696): pressure of air
    ...
    if input_str_1 in ('db', 'DB') or input_str_2 in ('db', 'DB'):
        ...
        if input_str_1 in ('dp', 'DP') or input_str_2 in ('dp', 'DP'):
            ...
            pass
        # no enthalpy, wet bulb and enthalpy are too closely related to avoid problems
    elif input_str_1 in ('dp', 'DP') or input_str_2 in ('dp', 'DP'):
        if output_str in ('dp', 'DP'):
            return dewpoint
        ...
        if input_str_1 in ('rh', 'RH') or input_str_2 in ('rh', 'RH'):
            ...
            pass
        # no humidity ratio - it is the dew point more or less
    elif input_str_1 in ('hr', 'HR') or input_str_2 in ('hr', 'HR'):
        if output_str in ('hr', 'HR'):
            return hum_rat
